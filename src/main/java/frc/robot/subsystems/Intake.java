...
public class Intake extends SubsystemBase {
    ...
    public void configMotors(){
        ...
        motionMagicConfigs1.MotionMagicCruiseVelocity = 80; // Target cruise velocity of 80 rps
        motionMagicConfigs1.MotionMagicAcceleration = 160; // Target acceleration of 160 rps/s (0.5 seconds)
